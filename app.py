...
CLUB_DISPLAY_ALIASES = {
    ...
    "ock": "OC Khouribga",
    "olympique casablanca": "OC (CLAS auparavant)",
    "olympique de casablanca": "OC (CLAS auparavant)",
    "oc": "OC (CLAS auparavant)",
    "coc": "OC (CLAS auparavant)",
    "clas": "OC (CLAS auparavant)",
    "clas casablanca": "OC (CLAS auparavant)",
